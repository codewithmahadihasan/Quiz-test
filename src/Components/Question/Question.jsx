      ...
      <div className="max-w-xl sm:mx-auto lg:max-w-2xl">
        <div className="flex flex-col mb-16 sm:text-center">
          ...
          <div className="max-w-xl md:mx-auto sm:text-center lg:max-w-2xl">
            <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
              ...
              more obstacles there are in the way of life, the more progress can
              be made
            </h2>
            <p className="text-base text-gray-700 md:text-lg">
              Try to known about the Question
            </p>
          </div>
        </div>
        <div className="space-y-4">
          ...
          <Item title="How does Context Api works ?">
            It can basically pass data to all its children. By doing this, all
            its children get data. For this where context API is used to access
            the data inside the wiz context. As a result, the loader does not
            have to be used again and again
          </Item>
          <Item title="What is useRaf ?">
